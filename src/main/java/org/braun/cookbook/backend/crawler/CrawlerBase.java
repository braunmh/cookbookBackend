 ...
 * @author mbraun
 */
public abstract class CrawlerBase<URL> extends BackgroundTask {
    ...
    protected abstract Recipe getRecipe(URL url);
    ...
    protected abstract String getPathParent(Recipe recipe, URL url);

    protected abstract List<URL> getNewRecipes();
